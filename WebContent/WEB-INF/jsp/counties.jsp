...
<div id="Wrapper">
	...
	<div id="Content">
		...
		<div id="Loop">
			<div class="post">
			<div id="title-header">
				<h1 class="title">COUNTY COVERAGE DASHBOARD </h1>
			</div>
						...
						<div id="menuBar">
								<ul class="slimmenu">
								    <li>
								        <a href="#">CCR</a>
								        <ul>
								            <li><a href="states.html">IPMUR</a></li>
							...
							<div class="box-layout">
								...
								<p><label for="lblCoverageType">CoverageType:</label></p>
									<div id="coverage-type-select">
										<input type="radio" id="qhp" name="qhp" checked="checked"><label for="qhp">QHP</label>
										<input type="radio" id="sadp" name="sadp" ><label for="sadp">SADP</label>
									</div>
